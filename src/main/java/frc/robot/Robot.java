...
public class Robot extends LoggedRobot {
    ...
    public void testInit() {
        ...
        //runs the systemsCheck
        if (robotContainer.getSystemsCheckCommand() != null) {
            CommandScheduler.getInstance().schedule(robotContainer.getSystemsCheckCommand());
        }
    }
