...
public final class Constants {
    ...
    public static final Pose2d BLUE_RIGHT_CENTER_LINE = new Pose2d((FIELD.getFieldLength() / 2.0) + Units.feetToMeters(2.0), FIELD.getTagPose(17).get().getY(), Rotation2d.fromDegrees(0.0));
