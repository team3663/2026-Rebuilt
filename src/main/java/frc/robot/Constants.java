...
public final class Constants {
    ...
    public static final Pose2d BLUE_RIGHT_CENTER_LINE_INTERMEDIATE = new Pose2d((FIELD.getFieldLength() / 2.0) - Units.feetToMeters(1.5),
            FIELD.getTagPose(17).get().getY() + Units.inchesToMeters(4.0), Rotation2d.fromDegrees(270.0));
    ...
    public static final Pose2d BLUE_RIGHT_NEUTRAL_ZONE_TRENCH_OFFSET = new Pose2d((FIELD.getFieldLength() / 2.0) - Units.feetToMeters(NEUTRAL_ZONE_ALLIANCE_SIDE_INTERMEDIATE_X_OFFSET + 1.0),
            FIELD.getTagPose(17).get().getY(), Rotation2d.fromDegrees(0.0));
    ...
    public static final Pose2d RED_RIGHT_CENTER_LINE_INTERMEDIATE = new Pose2d((FIELD.getFieldLength() / 2.0) + Units.feetToMeters(1.5),
            FIELD.getTagPose(1).get().getY() - Units.inchesToMeters(4.0), Rotation2d.fromDegrees(270.0));
    ...
    public static final Pose2d RED_RIGHT_NEUTRAL_ZONE_TRENCH_OFFSET = new Pose2d((FIELD.getFieldLength() / 2.0) + Units.feetToMeters(NEUTRAL_ZONE_ALLIANCE_SIDE_INTERMEDIATE_X_OFFSET + 1.0),
            FIELD.getTagPose(1).get().getY(), Rotation2d.fromDegrees(180.0));
    ...
    public static void RecordOutputs() {
        ...
        Logger.recordOutput("Field/BLUE_RIGHT_ALLIANCE_SIDE_INTERMEDIATE", BLUE_RIGHT_NEUTRAL_ZONE_TRENCH_OFFSET);
